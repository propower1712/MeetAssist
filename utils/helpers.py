...
def get_lambda_answer(name, arguments, lambda_client = None, function_name = None):
...
def get_users(_lambda_client = None, _function_name = None):
    response = get_lambda_answer("get_users_from_db", '{"content" : ""}', _lambda_client, _function_name)
...
def invoke_lambda(lambda_client, function_name, payload=None):
    ...
    logging.info("Invoking lambda function")
    ...
    try:
        ...
        logging.info("Lambda response - {}".format(response))
