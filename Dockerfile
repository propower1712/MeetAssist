...
# docker run -e FUNCTION_NAME=$(terraform output -raw lambda_function_arn) -e OPENAI_API_KEY=$(jq -r '.OPENAI_API_KEY' config.json) -p 8501:8501 -v ~/.aws:/root/.aws meet_assist_img